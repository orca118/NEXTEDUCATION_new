...
import { ArrowRight, Bot, Users, Heart, Sparkles } from 'lucide-react';
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6 leading-tight text-white">
              ...
              <span className="text-blue-400">
                Learn, Lead & Give Back
              </span>
            </h1>

            <p className="text-lg sm:text-xl text-slate-300 mb-10 max-w-2xl leading-relaxed">
              NEXT EDUCATION is creating student-led opportunities in STEM
              education, mentorship, leadership, and community service. Through
              robotics and peer mentorship, students develop their own skills
              while helping younger students discover new possibilities.
            </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-slate-600 mb-8 leading-relaxed">
              NEXT EDUCATION empowers students to become learners, mentors,
              leaders, and contributors to their communities. We create
              meaningful opportunities for students to explore STEM, share
              their experiences, develop leadership skills, and make
              educational opportunities more accessible to others.
            </p>

            <div className="p-8 bg-blue-50 rounded-3xl border border-blue-100">
              <p className="text-2xl font-medium text-blue-900 leading-snug">
                "Students can accomplish more when they learn from one another
                and use their experiences to help the next generation."
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-lg text-slate-600">
              We focus on student-led initiatives where experienced students
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            >
              ...
              <div className="p-8 flex flex-col flex-grow">
                ...
                <p className="text-blue-600 font-medium mb-4 text-sm uppercase tracking-wider">
                ...
                <p className="text-slate-600 mb-8 flex-grow">
                  ...
                  students with middle school students. Mentors share firsthand
                  experiences from robotics, science competitions, research,
                  and leadership to help younger students discover what's
                  possible.
                </p>
                ...
                <div className="space-y-2">
                  <a
                    href="#"
                    className="block w-full text-center px-4 py-2.5 bg-blue-600 text-white font-medium rounded-xl hover:bg-blue-700 transition-colors text-sm"
                  >
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <a
                      href="#"
                      className="block w-full text-center px-4 py-2.5 bg-blue-50 text-blue-700 font-medium rounded-xl hover:bg-blue-100 transition-colors text-sm"
                    >
                      Register as Student
                    </a>
                    ...
                    <a
                      href="#"
                      className="block w-full text-center px-4 py-2.5 bg-slate-50 text-slate-700 font-medium rounded-xl hover:bg-slate-100 border border-slate-200 transition-colors text-sm"
                    >
                      Become a Mentor
                    </a>
                  </div>
            ...
            >
              ...
              <div className="p-8 flex flex-col flex-grow">
                ...
                <p className="text-slate-500 font-medium mb-4 text-sm uppercase tracking-wider">
                  FTC Team #21587
                </p>

                <p className="text-slate-600 mb-8 flex-grow">
                  A student-led FIRST Tech Challenge robotics program. Beyond
                  building competitive robots, Orca Robotics emphasizes giving
                  back to the community through STEM outreach, robotics camps,
                  and exhibitions for younger students.
                </p>

                <div className="space-y-2 mt-auto">
                  <Link
                    to="/orca-robotics"
                    className="block w-full text-center px-4 py-2.5 bg-slate-800 text-white font-medium rounded-xl hover:bg-slate-900 transition-colors text-sm"
                  >
                    Visit Orca Robotics
                  </Link>
                </div>
      ...
      <section className="py-20 md:py-28 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold mb-6">
            Help Students Discover What's Possible
          </h2>

          <p className="text-xl text-blue-100 mb-10 leading-relaxed">
            Your support helps NEXT EDUCATION provide free educational
            programs, student mentorship, robotics opportunities, STEM
          ...
          <p className="mt-8 text-sm text-blue-200">
            NEXT EDUCATION, INC. is a 501(c)(3) nonprofit organization.
